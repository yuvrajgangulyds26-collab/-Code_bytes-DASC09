...
mae = mean_absolute_error(y_test, y_pred) #0.41
rmse = np.sqrt(mean_squared_error(y_test, y_pred)) #3.16
...
# -------- 7️ Save Model --------
joblib.dump(rf, "cab_fare_rf_coords_model.pkl")
print("Model saved as cab_fare_rf_coords_model.pkl")
